...
public static class MappingExtensions
{
    ...
    public static ShiftDto ToDto(this Shift s) => new()
    {
        ...
        OpeningDifferenceReviewStatus = s.OpeningDifferenceReviewStatus,
        OpeningDifferenceReviewedAt = s.OpeningDifferenceReviewedAt,
        OpeningDifferenceReviewedByUserId = s.OpeningDifferenceReviewedByUserId,
        OpeningDifferenceReviewNote = s.OpeningDifferenceReviewNote,
        ExpectedClosingBalance = s.ExpectedClosingBalance,
        CountedClosingBalance = s.CountedClosingBalance,
        Difference = s.Difference,
        ClosingDifferenceReviewStatus = s.ClosingDifferenceReviewStatus,
        ClosingDifferenceReviewedAt = s.ClosingDifferenceReviewedAt,
        ClosingDifferenceReviewedByUserId = s.ClosingDifferenceReviewedByUserId,
        ClosingDifferenceReviewNote = s.ClosingDifferenceReviewNote,
        OpenedAt = s.OpenedAt,
        ClosedAt = s.ClosedAt,
        Status = s.Status,
        Note = s.Note
