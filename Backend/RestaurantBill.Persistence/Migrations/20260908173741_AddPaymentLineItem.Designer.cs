...
namespace RestaurantBill.Persistence.Migrations
{
    ...
    [Migration("20260908173741_AddPaymentLineItem")]
    partial class AddPaymentLineItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantBill.Domain.Entities.PaymentLineItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RestaurantBill.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RestaurantBill.Domain.Entities.PaymentLineItem", b =>
                {
                    b.HasOne("RestaurantBill.Domain.Entities.Payment", "Payment")
                        .WithMany()
