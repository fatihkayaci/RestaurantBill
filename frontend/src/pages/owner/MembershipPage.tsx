    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                ...
                <button className="flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg border border-border text-sm font-medium text-foreground hover:bg-accent transition-colors shrink-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className={inputLikeCard}>
                    ...
                    <div className="flex items-center justify-between gap-3 flex-wrap rounded-lg border border-border p-4">
